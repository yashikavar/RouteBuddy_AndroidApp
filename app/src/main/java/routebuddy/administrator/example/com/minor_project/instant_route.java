...
public class instant_route extends AppCompatActivity implements View.OnClickListener {
    TextView t1;
    TextView t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instant_route);
        search= (Button)findViewById(R.id.buttoni1);
        change=(Button)findViewById(R.id.buttoni);
        t1=(TextView)findViewById(R.id.textViewi5);
        t2=(TextView)findViewById(R.id.textViewi7);
        t1.setText(new mapspage().get_source_i());
        t2.setText(new mapspage().get_destination_i());
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> implements DirectionFinderListener {
        ...
        protected void onPostExecute(String result) {
            ...
            int pcode = m.get_pincode_i();
            String org = m.get_source_i();
            String dest = m.get_destination_i();
            String go = m.get_go_time_i();
            String my_date = m.get_date_i();
            String days;
            ...
            try {
                ...
                while (count < jsonArray.length()) {
                    ...
                    //Log.d("enter0","enter0");
                    //Log.d(my_days,"days");
                    if (!login.equals(username) && pincode == pcode && date.equals(my_date))
                    {
                        Log.d("enter","enter");
                ...
                if(end==0)
                {
                    ...
                    startActivity(i);*/
                    AlertDialog.Builder builder = new AlertDialog.Builder(instant_route.this);
                    builder.setTitle("   Sorry !!  ");
                    builder.setMessage("No Friends Found :-(");
                    builder.setCancelable(true);
                    ...
                    timer2.schedule(new TimerTask() {
                        public void run() {
                            closedialog.dismiss();
                            timer2.cancel();
                            Intent i=new Intent(instant_route.this,main.class);
        ...
        public void onDirectionFinderSuccess(List<Route> routes) {
            ...
            for (Route route : routes) {
                ...
                {
                    progressDialog.dismiss();
                    Intent i1 = new Intent(instant_route.this, same_route_people_instant_check.class);
                    startActivity(i1);
                }
                //s1.substring(0,3);
                //give_route(s1);
    ...
    class BackgroundTask1 extends AsyncTask<String,Void, Void> {
        ...
        protected void onPostExecute(Void a) {
            Intent i = new Intent(instant_route.this, MapsActivity2.class);
            startActivity(i);
        }
    }
    List give_all_route()
