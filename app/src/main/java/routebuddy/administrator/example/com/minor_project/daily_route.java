...
public class daily_route extends AppCompatActivity implements View.OnClickListener {
    TextView t1;
    TextView t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search= (Button)findViewById(R.id.buttond1);
        change=(Button)findViewById(R.id.buttond);
        t1=(TextView)findViewById(R.id.textViewd5);
        t2=(TextView)findViewById(R.id.textViewd7);
        t1.setText(new mapspage().get_source_d());
        t2.setText(new mapspage().get_destination_d());
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> implements DirectionFinderListener {
        ...
        protected void onPreExecute() {
            ...
            json_url = "http://routebuddy.comli.com/json_get_data_daily.php";
        ...
        protected void onPostExecute(String result) {
            ...
            int pcode = m.get_pincode_d();
            String org = m.get_source_d();
            String dest = m.get_destination_d();
            String go = m.get_go_time_d();
            String come = m.get_come_time_d();
            String my_days = m.get_days_d();
            String days;
            ...
            try {
                ...
                while (count < jsonArray.length()) {
                    ...
                    //Log.d("enter0","enter0");
                    Log.d(my_days,"days");
                    if (!login.equals(username) && pincode == pcode && days.equals(my_days))
                    {
                        Log.d("enter","enter");
                        if (check_time(go, go_time) == 1 && check_time(come,come_time)==1)
                        {
                ...
                if(end==0)
                {
                    ...
                    /*AlertDialog.Builder builder = new AlertDialog.Builder(daily_route.this);
                    ...
                    t.cancel();
                    Intent i=new Intent(daily_route.this,main.class);
                    startActivity(i);*/
                    AlertDialog.Builder builder = new AlertDialog.Builder(daily_route.this);
                    builder.setTitle("   Sorry !!  ");
                    builder.setMessage("No Friends Found :-(");
        ...
        public void onDirectionFinderSuccess(List<Route> routes) {
            ...
            for (Route route : routes) {
                ...
                {
                    progressDialog.dismiss();
                    Intent i1 = new Intent(daily_route.this, same_route_people_daily_check.class);
                    startActivity(i1);
                }
                //s1.substring(0,3);
                //give_route(s1);
   ...
   @Override
        protected void onPreExecute() {
            Log.d("cc","cc");
            //    add_info_url="http://routebuddy.comli.com/add_info.php";
            json_url = "http://routebuddy.comli.com/json_remove_data_daily.php";
        ...
        protected void onPostExecute(Void a) {
            Intent i = new Intent(daily_route.this, MapsActivity2.class);
            startActivity(i);
        }
    }
    List give_all_route()
