...
import java.util.TimerTask;
 ...
 public class myroutes extends AppCompatActivity implements View.OnClickListener {
    TextView t1;
    TextView t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1.setText(new mapspage3().get_source());
        t2.setText(new mapspage3().get_destination());
        mapspage ma = new mapspage();
        login = ma.get_username();
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> implements DirectionFinderListener {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(end==0)
                {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(myroutes.this);
                    ...
                    timer2.schedule(new TimerTask() {
                        public void run() {
                            closedialog.dismiss();
                            timer2.cancel();
                            Intent i=new Intent(myroutes.this,main.class);
        ...
        public void onDirectionFinderSuccess(List<Route> routes) {
            ...
            for (Route route : routes) {
                ...
                if (end1 == end * 2) {
                    progressDialog.dismiss();
                    Intent i1 = new Intent(myroutes.this, same_route_people.class);
                    startActivity(i1);
                }
                //s1.substring(0,3);
                //give_route(s1);
    ...
    class BackgroundTask1 extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... args) {
            try {
                ...
                Log.d("given_username", login);
                BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                String data_string = URLEncoder.encode("username", "UTF-8") + "=" + URLEncoder.encode(login, "UTF-8");
        ...
        protected void onPostExecute(Void a) {
            Intent i = new Intent(myroutes.this, MapsActivity2.class);
            startActivity(i);
        }
    }
